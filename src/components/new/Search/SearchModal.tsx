...
export const SearchModal: React.FC<{}> = ({ }) => {
  ...
  return <div className="fixed inset-0 z-50 bg-[#333] bg-opacity-30">
    <div className="mt-[10vh] mx-auto w-1/2 min-w-[48rem] rounded-lg z-50 bg-background relative ring-1 ring-[#000]/10 shadow-xl">
      <div className="w-full flex flex-row items-center px-6 pl-4 py-4 space-x-4 border-b">

        <input
          autoFocus
          onChange={e => {
            setQuery(e.target.value)
          }} className="flex-1 text-lg text-gray-900 placeholder:text-gray-300 w-full h-full focus:outline-none" placeholder="Search or jump to..." />
